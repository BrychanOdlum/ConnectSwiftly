...
let package = Package(
    ...
    targets: [
      .target(name: "ConnectSwiftly", dependencies: [ .target(name: "Application"), "Kitura" , "HeliumLogger"]),
      .target(name: "Application", dependencies: [ "Kitura", "KituraCORS", "Configuration", "CloudEnvironment","SwiftMetrics","Health" ]),
